<aside class=" max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 p-0 antialiased transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:#97f2e0 shadow-soft-xl">
    <div class="h-19.5">
      ...
      <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:;" target="_blank">
        ...
        <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand"> UI Dashboard</span>
      </a>
    </div>
      ...
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/manager">
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Manager</span>
          </a>
        </li>
